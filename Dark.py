...
def tokenz():
	...
	try:
		...
		zedd.write(toket)
		zedd.close()
		jalan ('\033[1;97m[•]GA FOLLOW AKUN FB GUA MOGA² MASUK NERAKA:v ')
		print '\033[1;97m[\033[1;39m✓\033[1;97m]\033[1;39m HALLO'
		os.system('xdg-open https://www.facebook.com/randy.aprianto.31 ')
		bot_komen()
	except KeyError:
		print "\033[1;97m[\033[1;39m!\033[1;97m] \033[1;39mNgerti Token Gak Asw ?"
		time.sleep(1)
		masuk()
...
def clone():
	embuh = raw_input("\n\x1b[1;97m >>> ")
	if embuh =="":
		print "\033[1;96m[!] \x1b[1;91mNOT FOUND ERROR"
	elif embuh =="1":
...
def clone_dari_daftar_teman():
	...
	print"\033[1;96m[+] \033[1;92mHASIL \033[1;91m: \033[1;97m"+str(len(berhasil))
	print"\033[1;96m[+] \033[1;92mSUSCCES tersimpan \033[1;91m:\033[1;97m out/MailVuln.txt"
	raw_input("\n\033[1;96m[\033[1;97mBACK TOOLS\033[1;96m]")
	menu()
...
def clone_dari_teman():
	...
	try:
		...
		print"\033[1;96m[!] \x1b[1;91mTOKEN ERROR [•]"
		os.system('rm -rf login.txt')
		time.sleep(1)
		keluar()
	try:
	...
	jml = 0
	print 42*"\033[1;96m="
	idt = raw_input("\033[1;96m[+] \033[1;93mTEMPEL KAN ID TEMAN MU \033[1;91m: \033[1;97m")
	try:
		jok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
		op = json.loads(jok.text)
		...
		raw_input("\n\033[1;96m[\033[1;97mKembali\033[1;96m]")
		menu()
	jalan('\033[1;96m[✺] \033[1;93mSEDANG MENGAMBIL EMAIL \033[1;97m...')
	teman = requests.get('https://graph.facebook.com/'+idt+'/friends?access_token='+toket)
	kimak = json.loads(teman.text)
	jalan('\033[1;96m[✺] \033[1;93mMULAI [✓] \033[1;97m...')
	print('\x1b[1;96m[!] \x1b[1;93mBERHENTI [•] CTRL+z')
	print 43*"\033[1;96m="
	for w in kimak['data']:
		jml +=1
		mpsh.append(jml)
...
def clone_dari_member_group():
	...
	jml = 0
	print 42*"\033[1;96m="
	id=raw_input('\033[1;96m[+] \033[1;93mHARAP MASUKAN ID GRUPNYA \033[1;91m:\033[1;97m ')
	try:
		r=requests.get('https://graph.facebook.com/group/?id='+id+'&access_token='+toket)
		asw=json.loads(r.text)
		print"\033[1;96m[\033[1;97m✓\033[1;96m] \033[1;93mNama group \033[1;91m:\033[1;97m "+asw['name']
	except KeyError:
		print"\033[1;96m[!] \x1b[1;91mID GRUP TIDAK ADA"
		raw_input("\n\033[1;96m[\033[1;97mBACK TOOLS\033[1;96m]")
		menu()
	...
	print '\033[1;96m[\033[1;97m✓\033[1;96m] \033[1;92mDONE \033[1;97m....'
	print"\033[1;96m[+] \033[1;92mTotal \033[1;91m: \033[1;97m"+str(len(berhasil))
	print"\033[1;96m[+] \033[1;92mFILE TELAH TERSIMPAN \033[1;91m:\033[1;97m out/GrupMailVuln.txt"
...
def clone_dari_file():
	...
	try:
		...
		print"\033[1;96m[!] \x1b[1;91mTOKEN MU BASI :V"
		os.system('rm -rf login.txt')
		time.sleep(1)
		keluar()
	try:
	...
	try:
		...
		print"\033[1;96m[!] \x1b[1;91mMAFF FILE NOT FOUND"
		raw_input("\n\033[1;96m[\033[1;97mBACK TOOLS\033[1;96m]")
		menu()
	mpsh = []
	jml = 0
	...
	print '\033[1;96m[\033[1;97m✓\033[1;96m] \033[1;92mSelesai \033[1;97m....'
	print"\033[1;96m[+] \033[1;92mTotal \033[1;91m: \033[1;97m"+str(len(berhasil))
	print"\033[1;96m[+] \033[1;92mFILE TELAH Tersimpan \033[1;91m:\033[1;97m out/FileMailVuln.txt"
